...
public class ApolloCase
    ...
    public ApolloCase(PlayerMenuUtility playerMenuUtility) {
    ...
    private void runWin(Player player, ItemStack itemStack) {
        ...
        CaseSystem.getInstance().getCaseManager().executeCommandOrGiveItem(player, itemStack, "apollo");
    }
}
