...
public class PoseidonCase
    ...
    public PoseidonCase(PlayerMenuUtility playerMenuUtility) {
    ...
    private void runWin(Player player, ItemStack itemStack) {
        ...
        CaseSystem.getInstance().getCaseManager().executeCommandOrGiveItem(player, itemStack, "poseidon");
    }
}
